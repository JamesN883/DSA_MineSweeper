/* Name: 12
 ...
 Purpose: handle algorithms behind coutners and restart game when click on the smile.
*/
	...
	public PanelNotification(GamePanel game) {
		...
		bt.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				int option = JOptionPane.showConfirmDialog(null, "Do you want to start a new game?", "Notification",
