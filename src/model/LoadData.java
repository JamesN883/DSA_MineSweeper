/* Name: 12
 ...
 Purpose: import images for the game.
*/
...
public class LoadData {
	...
	public LoadData() {
		...
		try {
			//BufferedImage img = ImageIO.read(new File("C:/Users/James/Desktop/Project/minesweeper.png"));
			BufferedImage img = ImageIO.read(new File("minesweeper.png"));
			BufferedImage imgMine = ImageIO.read(new File("mine.png"));

			listImage.put("title", imgMine.getSubimage(0, 0, 1024, 1024));
			...
			listImage.put("check", img.getSubimage(140, 49, 7, 7));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
